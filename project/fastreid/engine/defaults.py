...
from project.fastreid.data import build_reid_test_loader, build_reid_train_loader
from project.fastreid.evaluation import (ReidEvaluator, ReidPredictor,
                                         inference_on_dataset, print_csv_format)
from project.fastreid.modeling.meta_arch import build_model
from project.fastreid.solver import build_lr_scheduler, build_optimizer
from project.fastreid.utils import comm
from project.fastreid.utils.checkpoint import Checkpointer
from project.fastreid.utils.collect_env import collect_env_info
from project.fastreid.utils.env import seed_all_rng
from project.fastreid.utils.events import CommonMetricPrinter, JSONWriter, TensorboardXWriter
from project.fastreid.utils.file_io import PathManager
from project.fastreid.utils.logger import setup_logger
from . import hooks
...
def default_argument_parser(bytes):
    """
    ...
    parser.add_argument("--config-file", default="project/sbs_mlp2x_inference_{}.yml".format(bytes), metavar="FILE",
    ...
    parser.add_argument("--infer-only", default=True, action="store_true", help="perform inference only")
