...
from project.fastreid.layers import *
from project.fastreid.layers import pooling, any_softmax
from project.fastreid.layers.weight_init import weights_init_kaiming
