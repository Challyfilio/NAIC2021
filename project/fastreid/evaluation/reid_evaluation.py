...
from project.fastreid.utils.compute_dist import build_dist
...
class ReidPredictor(ReidEvaluator):
    ...
    def evaluate(self):
        ...
        bytes = self.cfg.BYTE_RATE
        # print('cfg test:' + str(bytes))
        output_path = self.cfg.OUTPUT_DIR + '/{}.json'.format(bytes)
